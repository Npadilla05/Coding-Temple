...
new_skiable_terrain = []
for value, units in zip(df_resort['skiable_terrain'], df_resort['skiable_terrain']):
    if units == 'km':
        value = round(value * 247.105, 1)
        units = 'acres'
    new_skiable_terrain.append(str(value) + ' ' + units)

# new_skiable_terrain list to skiable_terrain
df_resort['skiable_terrain'] = new_skiable_terrain
